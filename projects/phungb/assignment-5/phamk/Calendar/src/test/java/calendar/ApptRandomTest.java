...
public class ApptRandomTest {
   ...
   public void randomTestIsValid() throws Throwable{
      for(int k=0; k<500; k++){   // running 500 Tests
         try{
            Random random = new Random();                      
            
            int startHour = ValuesGenerator.getRandomIntBetween(random, 0, 47);      // 50 valid hours
            ...
            if(startHour < 0 || startHour > 23)
               ...
               assertTrue(appt.getValid());            //Assert if minute is not valid*/
